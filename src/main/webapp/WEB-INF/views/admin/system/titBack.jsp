  ...
  <div class="panel-heading" style="padding-bottom: 0px; padding-top: 0px; padding-left: 0px; border-radius: 0px;">
    <ul class="nav nav-pills">
      <li role="presentation">
        <a href="${contextPath}/admin/system/routeTitBack.action"><span class="glyphicon glyphicon-map-marker"></span> &nbsp;间隔标题字体颜色配置</a>
      </li>
      <a href="${contextPath}/admin/system/titBackColorDefault.action" style="float: right; margin-top: 2px;">
  ...
  <div class="panel-body">
    <dl class="dl-horizontal">
      ...
      <dd>
        ...
        <c:if test="${titBackColor != null}" >
          <div style="width: 85%; height: 102px; background-color: ${titBackColor}; border: 1px solid black"></div>
        </c:if>
      </dd>
      <form class="form" action="${contextPath}/admin/system/titBackColorChange.action" method="post" style="margin-top: 50px">
        <div style="margin-left: 180px">
          <div class="form-group">
            <label for="color" style="margin-top: 7px">请移动圆圈选择颜色</label>
            <input style="width: 10%;float: right;margin-right: 670px" type="text" id="color" name="configColor" value="#969696" class="form-control"/>
          </div>
