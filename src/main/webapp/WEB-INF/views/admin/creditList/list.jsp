  ...
  <div class="panel-heading" style="padding-bottom: 0px; padding-top: 0px; padding-left: 0px; border-radius: 0px;">
    <ul class="nav nav-pills">
      <li role="presentation">
        <a href="${contextPath}/admin/course/routePage.action">
          <span class="glyphicon glyphicon-map-marker"></span> &nbsp;课程管理
        </a>
      </li>
      ...
      <li role="presentation" style="float: right; margin-top: 2px;">
        <button type="button" class="btn btn-warning navbar-btn" id="batchUpgrade" style="margin-top: 0px; margin-bottom: 0px;">升级</button>
      </li>
      <li role="presentation" style="float: right; margin-top: 2px;">
        <button type="button" class="btn btn-warning navbar-btn" id="batchGraduate" style="margin-top: 0px; margin-bottom: 0px;">毕业</button>
      </li>
    </ul>
  </div>
