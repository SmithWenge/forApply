...
-- ----------------------------
INSERT INTO `apply_creditlist` VALUES ('63a4bf63-4047-4c58-8382-3e36cc64e205', '1000', 'shi', '18632239374', '1', '19', 'sdaf', 'xuesheng', '6593399', '100', '100', '', '', '', '1', '2017-05-03', '2017-05-03 16:09:19', '0');
INSERT INTO `apply_creditlist` VALUES ('a05805bf-e85b-434a-a966-ca3effe03ac1', '1000', '史汉文', '18632239374', '1', '21', '大连交通', '学生', '6593399', '100', '100', '', '', '', '1', '2017-05-03', '2017-05-02 19:32:38', '0');
...
CREATE TABLE `lgb_log` (
  ...
  PRIMARY KEY (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COMMENT='日志表\r\n';
